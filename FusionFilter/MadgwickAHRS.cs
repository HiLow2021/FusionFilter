...
namespace FusionFilter
{
    ...
    /// </remarks>
    public class MadgwickAHRS : FusionFilter
    {
        /// <summary>
        ...
        /// Sample period.
        /// </param>
        public MadgwickAHRS(float samplePeriod) : this(samplePeriod, 0.1f)
        {
        }
        ...
        /// Algorithm gain beta.
        /// </param>
        public MadgwickAHRS(float samplePeriod, float beta) : base(samplePeriod)
        {
            Beta = beta;
        }
